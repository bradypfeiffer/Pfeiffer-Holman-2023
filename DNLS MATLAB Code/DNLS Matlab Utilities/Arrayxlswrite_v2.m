function Arrayxlswrite_v2(filename, Sheet, L, R, top, Params, heading,e)
...
eS.Range(AtoB).ColumnWidth = Maxstring;
...
xlsalign_v2(e, filename,Sheet,A1toB1,'MergeCells',1);
xlsalign_v2(e,filename,Sheet,A1toB1,'Horizontal',3);
xlsalign_v2(e, filename,Sheet,B2toBf,'Horizontal',3);